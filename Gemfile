...
# Authenticate user [https://github.com/jwt/ruby-jwt]
gem 'jwt'

# Hidden sensitive content [https://github.com/bkeepers/dotenv]
gem 'dotenv'
...
# SendGrid for email [https://github.com/sendgrid/sendgrid-ruby]
gem 'sendgrid-ruby'
